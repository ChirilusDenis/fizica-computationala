...
T=[300 400 6000]; %temperatura termodinamica a gazului, K
...
vmax=2e4; %viteza maxima in reprezentarile grafice, m/s
...
integral(@(v) Maxwell(v,kB,m0(1),T(3)),v1,v2)
